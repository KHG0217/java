...
/*
 * 	RuntimeException을 상속받은 Exception 종류는
...
public class MainClass02 {
	public static void main(String[] args) {
		...
		try {
			int num1 = Integer.parseInt(inputNum1);//몫
			int num2 = Integer.parseInt(inputNum2);//나머지
		...
		}catch(Exception e){ //위의 2가지 예외를 제외한 다른 Exception이 발생하면 실행되는 블럭
